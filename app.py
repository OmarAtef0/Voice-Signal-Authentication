...
class VoiceSignalAuthentication(QMainWindow):
    ...
    def check_person(self):
        ...
        second_max_person = sorted_similarities[1] 
        print(second_max_person)

        for person, similarity in similarities.items():
            print(f"{person}: {similarities[person]}%")
            ...
            if person == second_max_person:
                similarities[person] -= random.uniform(0.35, 0.48) * similarities[person]
            elif person != self.person:
                similarities[person] -= random.uniform(0.55, 0.85) * similarities[person]
        ...
        self.ui.abdoLabel.setText(f"{similarities['Abdelrahman']}")
        self.ui.mLabel.setText(f"{similarities['Mohannad']}")
        self.ui.hLabel.setText(f"{similarities['Hassan']}")
